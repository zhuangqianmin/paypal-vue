  ...
  <div class="content">
    ...
    <div class="center">
        ...
        <div class="pg-right">
          ...
          <div style="font-size: 20px;">配送料 はチェックアウト時に計算されます。</div>
          ...
          <div><Button class="button-info" size="large" @click="changPic(10)" :type="butArr.but1">¥10</Button></div>
          ...
          <div style="margin-top: 10px;"><Button class="button-info" size="large" long>カートに追加する</Button></div>
          <div style=""><Button type="success" class="button-info" size="large" @click="payMoney()" long>
